...
func (c *metadataServiceClient) RegisterUploadingObject(ctx context.Context, in *RegisterUploadingObjectRequest, opts ...grpc.CallOption) (*RegisterUploadingObjectResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterUploadingObjectResponse)
	err := c.cc.Invoke(ctx, MetadataService_RegisterUploadingObject_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetadataService_RegisterUploadingObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterUploadingObjectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetadataServiceServer).RegisterUploadingObject(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetadataService_RegisterUploadingObject_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetadataServiceServer).RegisterUploadingObject(ctx, req.(*RegisterUploadingObjectRequest))
	}
...
var MetadataService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rpc.metadata.MetadataService",
